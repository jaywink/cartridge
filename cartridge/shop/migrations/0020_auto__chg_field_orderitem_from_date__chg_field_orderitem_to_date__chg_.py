...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OrderItem.from_date'
        db.alter_column('shop_orderitem', 'from_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'OrderItem.to_date'
        db.alter_column('shop_orderitem', 'to_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'CartItem.from_date'
        db.alter_column('shop_cartitem', 'from_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'CartItem.to_date'
        db.alter_column('shop_cartitem', 'to_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'OrderItem.from_date'
        db.alter_column('shop_orderitem', 'from_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'OrderItem.to_date'
        db.alter_column('shop_orderitem', 'to_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'CartItem.from_date'
        db.alter_column('shop_cartitem', 'from_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'CartItem.to_date'
        db.alter_column('shop_cartitem', 'to_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
