...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('shop_order', 'shipping_detail_state', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Order.billing_detail_state'
        db.alter_column('shop_order', 'billing_detail_state', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Order.shipping_detail_state'
        db.alter_column('shop_order', 'shipping_detail_state', self.gf('django.db.models.fields.CharField')(default='-', max_length=100))

        # Changing field 'Order.billing_detail_state'
        db.alter_column('shop_order', 'billing_detail_state', self.gf('django.db.models.fields.CharField')(default='-', max_length=100))
    ...
    models = {
        ...
        'shop.order': {
            ...
            'billing_detail_state': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
            ...
            'shipping_detail_state': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
