...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SpecialPrice.title'
        db.add_column(u'shop_specialprice', 'title',
                      self.gf('django.db.models.fields.CharField')(default=u'Special price', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'SpecialPrice.from_date'
        db.add_column(u'shop_specialprice', 'from_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SpecialPrice.to_date'
        db.add_column(u'shop_specialprice', 'to_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SpecialPrice.title'
        db.delete_column(u'shop_specialprice', 'title')

        # Deleting field 'SpecialPrice.from_date'
        db.delete_column(u'shop_specialprice', 'from_date')

        # Deleting field 'SpecialPrice.to_date'
        db.delete_column(u'shop_specialprice', 'to_date')
