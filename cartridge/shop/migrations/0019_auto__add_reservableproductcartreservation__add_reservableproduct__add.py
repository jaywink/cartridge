...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('shop_reservableproductcartreservation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cart', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reservations', to=orm['shop.Cart'])),
            ('reservation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='in_carts', to=orm['shop.ReservableProductReservation'])),
            ('last_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('shop', ['ReservableProductCartReservation'])

        # Adding model 'ReservableProduct'
        db.create_table('shop_reservableproduct', (
            ('product_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['shop.Product'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('shop', ['ReservableProduct'])

        # Adding model 'ReservableProductOrderReservation'
        db.create_table('shop_reservableproductorderreservation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reservations', to=orm['shop.Order'])),
            ('reservation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='in_orders', to=orm['shop.ReservableProductReservation'])),
            ('last_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('shop', ['ReservableProductOrderReservation'])

        # Adding model 'SpecialPrice'
        db.create_table('shop_specialprice', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='specialprices', to=orm['shop.Product'])),
        ))
        db.send_create_signal('shop', ['SpecialPrice'])

        # Adding model 'ReservableProductReservation'
        db.create_table('shop_reservableproductreservation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reservations', to=orm['shop.ReservableProduct'])),
        ))
        db.send_create_signal('shop', ['ReservableProductReservation'])

        # Adding field 'CartItem.from_date'
        db.add_column('shop_cartitem', 'from_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'CartItem.to_date'
        db.add_column('shop_cartitem', 'to_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'OrderItem.from_date'
        db.add_column('shop_orderitem', 'from_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'OrderItem.to_date'
        db.add_column('shop_orderitem', 'to_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Product.content_model'
        db.add_column('shop_product', 'content_model',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('shop_reservableproductcartreservation')

        # Deleting model 'ReservableProduct'
        db.delete_table('shop_reservableproduct')

        # Deleting model 'ReservableProductOrderReservation'
        db.delete_table('shop_reservableproductorderreservation')

        # Deleting model 'SpecialPrice'
        db.delete_table('shop_specialprice')

        # Deleting model 'ReservableProductReservation'
        db.delete_table('shop_reservableproductreservation')

        # Deleting field 'CartItem.from_date'
        db.delete_column('shop_cartitem', 'from_date')

        # Deleting field 'CartItem.to_date'
        db.delete_column('shop_cartitem', 'to_date')

        # Deleting field 'OrderItem.from_date'
        db.delete_column('shop_orderitem', 'from_date')

        # Deleting field 'OrderItem.to_date'
        db.delete_column('shop_orderitem', 'to_date')

        # Deleting field 'Product.content_model'
        db.delete_column('shop_product', 'content_model')
    ...
    models = {
        ...
        'shop.cartitem': {
            ...
            'from_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'to_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
