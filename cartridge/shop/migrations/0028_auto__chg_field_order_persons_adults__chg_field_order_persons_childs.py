...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.persons_adults'
        db.alter_column(u'shop_order', 'persons_adults', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Order.persons_childs'
        db.alter_column(u'shop_order', 'persons_childs', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Order.persons_adults'
        db.alter_column(u'shop_order', 'persons_adults', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Order.persons_childs'
        db.alter_column(u'shop_order', 'persons_childs', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'shop.order': {
            ...
            'persons_adults': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'persons_childs': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
        ...
        u'shop.specialprice': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'default': "u'Special price'", 'max_length': '200', 'blank': 'True'}),
