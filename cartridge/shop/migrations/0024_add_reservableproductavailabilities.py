...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'shop_reservableproductavailability', (
            ...
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='availabilities', to=orm['shop.ReservableProduct'])),
        ))
    ...
    models = {
        ...
        u'shop.reservableproductavailability': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'availabilities'", 'to': u"orm['shop.ReservableProduct']"}),
            'to_date': ('django.db.models.fields.DateField', [], {})
        },
        u'shop.reservableproductcartreservation': {
            'Meta': {'object_name': 'ReservableProductCartReservation'},
            'cart': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'reservations'", 'to': u"orm['shop.Cart']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'reservation': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'in_carts'", 'to': u"orm['shop.ReservableProductReservation']"})
        },
        u'shop.reservableproductorderreservation': {
            'Meta': {'object_name': 'ReservableProductOrderReservation'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'reservations'", 'to': u"orm['shop.Order']"}),
            'reservation': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'in_orders'", 'to': u"orm['shop.ReservableProductReservation']"})
        },
        u'shop.reservableproductreservation': {
            'Meta': {'object_name': 'ReservableProductReservation'},
            'date': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'reservations'", 'to': u"orm['shop.ReservableProduct']"})
        },
        u'shop.sale': {
        ...
        u'shop.specialprice': {
            ...
            'product': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'specialprices'", 'to': u"orm['shop.Product']"}),
