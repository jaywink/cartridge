...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.persons_adults'
        db.add_column(u'shop_order', 'persons_adults',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'Order.persons_childs'
        db.add_column(u'shop_order', 'persons_childs',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.persons_adults'
        db.delete_column(u'shop_order', 'persons_adults')

        # Deleting field 'Order.persons_childs'
        db.delete_column(u'shop_order', 'persons_childs')
    ...
    models = {
        ...
        u'shop.order': {
            ...
            'persons_adults': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            'persons_childs': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
